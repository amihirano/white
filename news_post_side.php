<div class="col-sm-3">
<a href="news_list.html" class="btn btn-sm btn-block bg-navy text-white mb-3">お知らせ一覧</a>


<?php
$sql = "select * from post where code!='$_GET[code]' and cate like '%001%' order by date DESC limit 5";
$stmt=$dbh->query($sql);
...
$img_url="eyecatch/$row[code].jpeg";
if(is_file($img_url)){$img=$img_url;}
...
$img_url="eyecatch/$row[code].heic";
if(is_file($img_url)){$img=$img_url;}
