...
// $ext_list=array("jpg","jpeg","png","gif","heic");
// for($i=0;$i<sizeof($ext_list);$i++){
// 	$img="./eyecatch/$row[code]_thumb.".$ext_list[$i];
// 	if(is_file($img)){$ext=$ext_list[$i];break;}
// }
...
$eyeimg="./eyecatch/$row[code]_thumb.heic";
if(is_file($eyeimg)){
	$eye="./eyecatch/$row[code]_thumb.heic";
}
